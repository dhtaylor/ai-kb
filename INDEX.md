...
- [semantic](semantic/INDEX.md) — knowledge domains, one folder each
...
- [golden-retrieval](golden-retrieval/INDEX.md) — per-domain retrieval eval sets

The remaining tier folders — `episodic/`, `procedural/` — are listed here as they come into
existence. Do not route to an empty folder.
